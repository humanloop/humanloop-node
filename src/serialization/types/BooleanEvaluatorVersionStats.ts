...
export const BooleanEvaluatorVersionStats: core.serialization.ObjectSchema<
    serializers.BooleanEvaluatorVersionStats.Raw,
...
export declare namespace BooleanEvaluatorVersionStats {
    interface Raw {
