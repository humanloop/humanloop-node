...
import { AgentCallResponseToolChoice } from "./AgentCallResponseToolChoice";
import { LogStatus } from "./LogStatus";

export const AgentCallResponse: core.serialization.ObjectSchema<
    serializers.AgentCallResponse.Raw,
    Humanloop.AgentCallResponse
> = core.serialization.object({
    ...
    toolChoice: core.serialization.property("tool_choice", AgentCallResponseToolChoice.optional()),
...
export declare namespace AgentCallResponse {
    export interface Raw {
        ...
        tool_choice?: AgentCallResponseToolChoice.Raw | null;
