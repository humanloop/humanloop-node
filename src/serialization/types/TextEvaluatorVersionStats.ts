...
export const TextEvaluatorVersionStats: core.serialization.ObjectSchema<
    serializers.TextEvaluatorVersionStats.Raw,
...
export declare namespace TextEvaluatorVersionStats {
    interface Raw {
