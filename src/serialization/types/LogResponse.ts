...
import { LogResponseJudgment } from "./LogResponseJudgment";
...
import { LogResponseToolChoice } from "./LogResponseToolChoice";
import { ObservabilityStatus } from "./ObservabilityStatus";

export const LogResponse: core.serialization.ObjectSchema<serializers.LogResponse.Raw, Humanloop.LogResponse> =
    core.serialization.object({
        ...
        judgment: LogResponseJudgment.optional(),
        ...
        metricValues: core.serialization.property(
            "metric_values",
            core.serialization.list(MetricValueResponse).optional()
        ),
        ...
        batchIds: core.serialization.property(
            "batch_ids",
...
export declare namespace LogResponse {
    interface Raw {
        ...
        output?: string | null;
        judgment?: LogResponseJudgment.Raw | null;
        ...
        tool_choice?: LogResponseToolChoice.Raw | null;
