...
export const AgentLogRequest: core.serialization.Schema<
    serializers.AgentLogRequest.Raw,
    Omit<Humanloop.AgentLogRequest, "versionId" | "environment">
> = core.serialization.object({
    ...
    agentLogRequestEnvironment: core.serialization.property("environment", core.serialization.string().optional()),
    save: core.serialization.boolean().optional(),
    logId: core.serialization.property("log_id", core.serialization.string().optional()),
});

export declare namespace AgentLogRequest {
