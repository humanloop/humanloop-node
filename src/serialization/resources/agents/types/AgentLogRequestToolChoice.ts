...
export const AgentLogRequestToolChoice: core.serialization.Schema<
    serializers.AgentLogRequestToolChoice.Raw,
    Humanloop.AgentLogRequestToolChoice
...
export declare namespace AgentLogRequestToolChoice {
