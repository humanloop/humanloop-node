...
export interface AgentResponse {
     ...
     */
    template?: Humanloop.AgentResponseTemplate;
    ...
    stop?: Humanloop.AgentResponseStop;
    ...
    reasoningEffort?: Humanloop.AgentResponseReasoningEffort;
    /** List of tools that the Agent can call. These can be linked files or inline tools. */
    tools: Humanloop.AgentResponseToolsItem[];
