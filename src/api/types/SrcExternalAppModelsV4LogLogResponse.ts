 ...
 */
export interface SrcExternalAppModelsV4LogLogResponse {
    ...
    output?: string;
    judgment?: Humanloop.SrcExternalAppModelsV4LogLogResponseJudgment;
    ...
    toolChoice?: Humanloop.SrcExternalAppModelsV4LogLogResponseToolChoice;
