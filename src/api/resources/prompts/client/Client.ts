 ...
 *
 * Prompts have immutable versions that you can **Save** and **Deploy**.
...
export class Prompts {
    ...
    public async log(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError("Timeout exceeded when calling POST /prompts/log.");
            case "unknown":
                throw new errors.HumanloopError({
     ...
     * @param {Humanloop.PromptLogUpdateRequest} request
     * @param {Prompts.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Humanloop.UnprocessableEntityError}
     *
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.HumanloopEnvironment.Default,
                `prompts/${encodeURIComponent(id)}/log/${encodeURIComponent(logId)}`,
            ),
            method: "PATCH",
            headers: {
                "X-Fern-Language": "JavaScript",
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.PromptLogUpdateRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError(
                    "Timeout exceeded when calling PATCH /prompts/{id}/log/{log_id}.",
                );
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
    ...
    public async callStream(
        ...
        requestOptions?: Prompts.RequestOptions,
    ): Promise<core.Stream<Humanloop.PromptCallStreamResponse>> {
        const { versionId, environment, ..._body } = request;
        const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
        if (versionId != null) {
            _queryParams["version_id"] = versionId;
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)<stream.Readable>({
            ...
            requestType: "json",
            body: {
                ...serializers.PromptsCallStreamRequest.jsonOrThrow(_body, { unrecognizedObjectKeys: "strip" }),
                stream: true,
            },
            responseType: "sse",
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
        ...
        if (_response.ok) {
            return new core.Stream({
                ...
                parse: async (data) => {
                    return serializers.PromptCallStreamResponse.parseOrThrow(data, {
                        unrecognizedObjectKeys: "passthrough",
                        allowUnrecognizedUnionMembers: true,
                        allowUnrecognizedEnumValues: true,
                        skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError("Timeout exceeded when calling POST /prompts/call.");
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
                });
     ...
     * in the case where you are storing or deriving your Prompt details in code.
     *
     * @param {Humanloop.PromptsCallRequest} request
     * @param {Prompts.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Humanloop.UnprocessableEntityError}
     *
    ...
    public async call(
        ...
        requestOptions?: Prompts.RequestOptions,
    ): Promise<Humanloop.PromptCallResponse> {
        const { versionId, environment, ..._body } = request;
        const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
        if (versionId != null) {
            _queryParams["version_id"] = versionId;
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: {
                ...serializers.PromptsCallRequest.jsonOrThrow(_body, { unrecognizedObjectKeys: "strip" }),
                stream: false,
            },
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
    ...
    public async list(
        ...
        const list = async (
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.HumanloopTimeoutError("Timeout exceeded when calling GET /prompts.");
                case "unknown":
                    throw new errors.HumanloopError({
                        message: _response.error.errorMessage,
                    });
    ...
    public async upsert(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError("Timeout exceeded when calling POST /prompts.");
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
                });
    ...
    public async get(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError("Timeout exceeded when calling GET /prompts/{id}.");
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
                });
    ...
    public async delete(id: string, requestOptions?: Prompts.RequestOptions): Promise<void> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError("Timeout exceeded when calling DELETE /prompts/{id}.");
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
                });
    ...
    public async move(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError("Timeout exceeded when calling PATCH /prompts/{id}.");
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {string} id - Unique identifier for Prompt.
     * @param {Humanloop.PopulatePromptsIdPopulatePostRequest} request
     * @param {Prompts.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Humanloop.UnprocessableEntityError}
     *
    ...
    public async populate(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            queryParameters: _queryParams,
            requestType: "json",
            body: serializers.prompts.populate.Request.jsonOrThrow(_body, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError("Timeout exceeded when calling POST /prompts/{id}/populate.");
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
                });
    ...
    public async listVersions(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError("Timeout exceeded when calling GET /prompts/{id}/versions.");
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
                });
    ...
    public async deletePromptVersion(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError(
                    "Timeout exceeded when calling DELETE /prompts/{id}/versions/{version_id}.",
                );
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
    ...
    public async patchPromptVersion(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError(
                    "Timeout exceeded when calling PATCH /prompts/{id}/versions/{version_id}.",
                );
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
    ...
    public async setDeployment(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError(
                    "Timeout exceeded when calling POST /prompts/{id}/environments/{environment_id}.",
                );
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
    ...
    public async removeDeployment(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError(
                    "Timeout exceeded when calling DELETE /prompts/{id}/environments/{environment_id}.",
                );
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
    ...
    public async listEnvironments(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError("Timeout exceeded when calling GET /prompts/{id}/environments.");
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
                });
    ...
    public async updateMonitoring(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError("Timeout exceeded when calling POST /prompts/{id}/evaluators.");
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {string} id - Unique identifier for Prompt.
     * @param {Humanloop.SerializePromptsIdSerializeGetRequest} request
     * @param {Prompts.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Humanloop.UnprocessableEntityError}
     *
    ...
    public async serialize(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.HumanloopEnvironment.Default,
                `prompts/${encodeURIComponent(id)}/serialize`,
            ),
            method: "GET",
            headers: {
                "X-Fern-Language": "JavaScript",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError("Timeout exceeded when calling GET /prompts/{id}/serialize.");
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {Humanloop.BodyDeserializePromptsDeserializePost} request
     * @param {Prompts.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Humanloop.UnprocessableEntityError}
     *
    ...
    public async deserialize(
        ...
        requestOptions?: Prompts.RequestOptions,
    ): Promise<Humanloop.PromptKernelRequest> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.BodyDeserializePromptsDeserializePost.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
        ...
        if (_response.ok) {
            return serializers.PromptKernelRequest.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.HumanloopTimeoutError("Timeout exceeded when calling POST /prompts/deserialize.");
            case "unknown":
                throw new errors.HumanloopError({
                    message: _response.error.errorMessage,
                });
